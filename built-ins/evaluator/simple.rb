...
define_type :simple do
  ...
  # The single objective that this evaluator should optimise.
  attribute :candidate_evaluator, ruby(:proc)

  # The number of threads the evaluation should be spread across.
  ...
  composer do
    s = spec(:evaluator, :simple).extend
    s.implement_method(:evaluate_candidate, &candidate_evaluator)
    s.constructor([], source: "super(#{threads})")
    s
  end
